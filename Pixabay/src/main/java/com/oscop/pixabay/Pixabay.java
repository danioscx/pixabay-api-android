...
import com.oscop.pixabay.utils.Category;
import com.oscop.pixabay.utils.Colors;
import com.oscop.pixabay.utils.ImageType;
import com.oscop.pixabay.model.Images;
import com.oscop.pixabay.utils.Language;
import com.oscop.pixabay.utils.Order;
import com.oscop.pixabay.utils.Orientation;
...
public class Pixabay {
    ...
    public static class Video {
        ...
        public interface OnPixabayVideoRequest {
            void onResult(List<com.oscop.pixabay.model.Videos> videos);
            void onError(String error);
        }
        ...
        public void setOnPixabayVideoRequest(@NonNull Video pixabay, OnPixabayVideoRequest request) {
            JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET,
                ...
                try {
                    JSONArray array = response.getJSONArray("hits");
                    List<com.oscop.pixabay.model.Videos> videos = new ArrayList<>();
                    for (int i = 0; i < array.length() ; i++) {
                        JSONObject object = array.getJSONObject(i);
                        ...
                        com.oscop.pixabay.model.Videos video = com.oscop.pixabay.model.Videos.getInstance()
                                .withId(object.getString("id"))
                                .withPageURL(object.getString("pageURL"))
                                .withType(object.getString("type"))
                                .withTags(object.getString("tags"))
