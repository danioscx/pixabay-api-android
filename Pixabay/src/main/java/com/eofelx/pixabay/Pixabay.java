...
import com.eofelx.pixabay.utils.Category;
import com.eofelx.pixabay.utils.Colors;
import com.eofelx.pixabay.utils.ImageType;
import com.eofelx.pixabay.model.Images;
import com.eofelx.pixabay.utils.Language;
import com.eofelx.pixabay.utils.Order;
import com.eofelx.pixabay.utils.Orientation;
...
public class Pixabay {
    ...
    public static class Video {
        ...
        public interface OnPixabayVideoRequest {
            void onResult(List<com.eofelx.pixabay.model.Videos> videos);
            void onError(String error);
        }
        ...
        public void setOnPixabayVideoRequest(@NonNull Video pixabay, OnPixabayVideoRequest request) {
            JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET,
                ...
                try {
                    JSONArray array = response.getJSONArray("hits");
                    List<com.eofelx.pixabay.model.Videos> videos = new ArrayList<>();
                    for (int i = 0; i < array.length() ; i++) {
                        JSONObject object = array.getJSONObject(i);
                        ...
                        com.eofelx.pixabay.model.Videos video = com.eofelx.pixabay.model.Videos.getInstance()
                                .withId(object.getString("id"))
                                .withPageURL(object.getString("pageURL"))
                                .withType(object.getString("type"))
                                .withTags(object.getString("tags"))
